...
func TestBuildRawEMLForDraftCreate_ResolvesLocalImages(t *testing.T) {
	...
	rawEML, err := buildRawEMLForDraftCreate(context.Background(), newRuntimeWithFrom("sender@example.com"), input, nil, "", nil, "", "", nil)
	if err != nil {
...
func TestBuildRawEMLForDraftCreate_AutoResolveCountedInSizeLimit(t *testing.T) {
	...
	_, err := buildRawEMLForDraftCreate(context.Background(), newRuntimeWithFrom("sender@example.com"), input, nil, "", nil, "", "", nil)
	if err == nil {
...
func TestBuildRawEMLForDraftCreate_WithPriority(t *testing.T) {
	...
	rawEML, err := buildRawEMLForDraftCreate(context.Background(), newRuntimeWithFrom("sender@example.com"), input, nil, "1", nil, "", "", nil)
	if err != nil {
		t.Fatalf("buildRawEMLForDraftCreate() error = %v", err)
	}
	eml := decodeBase64URL(rawEML)
...
func TestBuildRawEMLForDraftCreate_RequestReceiptAddsHeader(t *testing.T) {
	...
	rawEML, err := buildRawEMLForDraftCreate(context.Background(),
		newRuntimeWithFromAndRequestReceipt("sender@example.com", true), input, nil, "", nil, "", "", nil)
	if err != nil {
		t.Fatalf("buildRawEMLForDraftCreate() error = %v", err)
	}
	eml := decodeBase64URL(rawEML)
...
func TestBuildRawEMLForDraftCreate_RequestReceiptOmittedByDefault(t *testing.T) {
	...
	rawEML, err := buildRawEMLForDraftCreate(context.Background(),
		newRuntimeWithFromAndRequestReceipt("sender@example.com", false), input, nil, "", nil, "", "", nil)
	if err != nil {
		t.Fatalf("buildRawEMLForDraftCreate() error = %v", err)
	}
	eml := decodeBase64URL(rawEML)
