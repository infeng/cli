...
var MailDraftCreate = common.Shortcut{
	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		rawEML, err := buildRawEMLForDraftCreate(ctx, runtime, input, sigResult, templateLargeAttachmentIDs)
		if err != nil {
			return err
		}
...
func buildRawEMLForDraftCreate(ctx context.Context, runtime *common.RuntimeContext, input draftCreateInput, sigResult *signatureResult, templateLargeAttachmentIDs []string) (string, error) {
